...
return [
    ...
    */
    ...
    'connections' => [
        ...
        |----------------------------------------------------------------------
        |
        | Laravel connects via the standard PostgreSQL driver using the
        | Supabase connection pooler (port 5432 or 6543 for pgBouncer).
        | Uses service_role credentials – RLS bypassed at DB level.
        | Business logic is enforced entirely by Laravel.
        |
        */
        'supabase' => [
            'driver'         => 'pgsql',

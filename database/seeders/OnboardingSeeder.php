...
class OnboardingSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('onboarding_steps')->insert([
            // Common Flow
            ['id' => 'step_personal_name', 'flow_id' => 'flow_common', 'order_index' => 1, 'section' => 'Data Diri', 'title' => 'Siapa nama Anda?', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['id' => 'step_bld_role', 'flow_id' => 'flow_builder_common', 'order_index' => 3, 'section' => 'Peran Pekerjaan', 'title' => 'Apa peran/jabatan utama Anda?', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 'step_founder_intent', 'flow_id' => 'flow_builder_common', 'order_index' => 4, 'section' => 'Tujuan Founder', 'title' => 'Apa tujuan Anda merekrut di platform ini?', 'created_at' => now(), 'updated_at' => now()],
            
            // Branching Flows
            ['id' => 'step_flow_a', 'flow_id' => 'flow_a', 'order_index' => 1, 'section' => 'Mencari Co-Founder', 'title' => 'Tipe Co-Founder yang Anda cari?', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 'step_flow_b', 'flow_id' => 'flow_b', 'order_index' => 1, 'section' => 'Mencari Tim', 'title' => 'Kriteria Tim yang Anda cari?', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 'step_flow_c', 'flow_id' => 'flow_c', 'order_index' => 1, 'section' => 'Mencari Co-Founder & Tim', 'title' => 'Apa yang Anda cari?', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 'step_flow_d', 'flow_id' => 'flow_d', 'order_index' => 1, 'section' => 'Menjadi Co-Founder', 'title' => 'Detail Co-Founder (Anda)', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 'step_flow_e', 'flow_id' => 'flow_e', 'order_index' => 1, 'section' => 'Menjadi Anggota Tim', 'title' => 'Detail Keahlian (Anda)', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 'step_flow_f', 'flow_id' => 'flow_f', 'order_index' => 1, 'section' => 'Profil Startup', 'title' => 'Mohon Lengkapi Profil Startup Anda', 'created_at' => now(), 'updated_at' => now()],
        ]);

        $q = function ($id, $step_id, $order, $type, $label, $required = true, $validation = null, $depends_on = null) use ($now) {
            return [

...
class OnboardingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $locations = [
            ...
            ['Manchester, UK', 'manchester', 'Eropa'],
            ['Berlin, Germany', 'berlin', 'Eropa'],
            ['Munich, Germany', 'munich', 'Eropa'],
            ['Amsterdam, Netherlands', 'amsterdam', 'Eropa'],
            ['Rotterdam, Netherlands', 'rotterdam', 'Eropa'],
            ['Paris, France', 'paris', 'Eropa'],
            ['Lyon, France', 'lyon', 'Eropa'],
            ['Stockholm, Sweden', 'stockholm', 'Eropa'],
            ['Zurich, Switzerland', 'zurich', 'Eropa'],
            ['Geneva, Switzerland', 'geneva', 'Eropa'],
            ['Lisbon, Portugal', 'lisbon', 'Eropa'],
            ['Porto, Portugal', 'porto', 'Eropa'],
            ['Barcelona, Spain', 'barcelona', 'Eropa'],
            ['Madrid, Spain', 'madrid', 'Eropa'],
            ['Rome, Italy', 'rome', 'Eropa'],
            ['Milan, Italy', 'milan', 'Eropa'],
            ['Warsaw, Poland', 'warsaw', 'Eropa'],
            ['Tallinn, Estonia', 'tallinn', 'Eropa'],
            ['Dublin, Ireland', 'dublin', 'Eropa'],
            ['Helsinki, Finland', 'helsinki', 'Eropa'],
            ['Copenhagen, Denmark', 'copenhagen', 'Eropa'],
            ['Oslo, Norway', 'oslo', 'Eropa'],
            ['Vienna, Austria', 'vienna', 'Eropa'],
            ['Prague, Czech Republic', 'prague', 'Eropa'],
